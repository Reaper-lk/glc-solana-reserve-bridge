...
- **Solana program ID** (`6tmLSP2j2thito2RpByqgfKHuVRSLcNd9c5FkrLJMjja` — updated 2026-08-22; was `bdUmuB79BUngf9Dd1ZRN3U3xBJMpsixpHaeC9Z3rta4` at the time this document was originally written, since replaced — see `docs/22-production-readiness-review.md` P0-6) — this is a program executable account, not a token account; it cannot hold or account for SPL tokens sent to it in any useful way.
